...
import { Shield, Download, CheckCircle, Calendar, MapPin, User, BadgeCheck } from "lucide-react";
    ...
    <div className="min-h-screen bg-gradient-to-br from-secondary/10 to-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <div className="text-xs text-muted-foreground">Certificate Download</div>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="text-center mb-8">
          ...
          <h1 className="mb-2">Certificate {isDigitized ? 'Digitized' : 'Approved'}!</h1>
          <p className="text-muted-foreground">
            {isDigitized ? 'Your digitized certificate is ready for download' : 'Your certificate is ready for download'}
          </p>
          {isDigitized && (
            ...
            <div className="bg-gradient-to-br from-secondary/20 to-white p-12 rounded-t-xl border-b-4 border-primary">
              <div className="text-center space-y-6">
                ...
                <div className="relative">
                  <p className="text-sm text-muted-foreground mb-2">FEDERAL REPUBLIC OF NIGERIA</p>
                  <h2 className="text-primary mb-1">Local Government Indigene Certificate</h2>
                  <p className="text-sm text-muted-foreground">Certificate of Origin</p>
                  {isDigitized && (
                ...
                <div className="bg-white rounded-xl p-8 shadow-sm max-w-2xl mx-auto">
                  ...
                  <p className="text-sm leading-relaxed text-muted-foreground mb-6">
                    is an indigene of <span className="text-foreground">Ikeja Local Government Area</span> in <span className="text-foreground">Lagos State</span>, 
                    Federal Republic of Nigeria. This certificate is issued upon satisfactory verification of the applicant's claim to indigeneship.
                  </p>
                  ...
                  <div className="mt-6 text-center">
                    <p className="text-xs text-muted-foreground">Issue Date: October 15, 2025</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <Card className="rounded-xl shadow-sm">
          ...
          <CardContent className="space-y-4">
            ...
            <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
              <p className="text-sm">
                <span className="text-yellow-800">Note:</span> This certificate is valid for 7 days from the approval date. 
                Please download and save your certificate within this period.
              </p>
            </div>

            <div className="flex gap-4">
              <Button variant="outline" className="flex-1" onClick={() => onNavigate('verify')}>
                Verify Certificate
              </Button>
              <Button variant="outline" className="flex-1" onClick={() => onNavigate('applicant-dashboard')}>
                Back to Dashboard
              </Button>
            </div>
          </CardContent>
